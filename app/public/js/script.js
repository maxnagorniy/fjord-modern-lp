...
$(document).ready(function() {
    ...
    $('.header__btn').on('click', function() {
        $('.header__nav-menu').slideToggle(300, function(){
    ...
    // Slider Phone Perspective

    $('.slider-phone').slick({
        dots: false,
        arrows: true,
        prevArrow:"<button type='button' class='slider-phone__arrow arrow-prev'></button>",
        nextArrow:"<button type='button' class='slider-phone__arrow arrow-next'></button>"
    });

    $('.arrow-prev').on('click', function () {
        var getDataColor = $('.slick-current > div').data('color');
        $('.slide-block').css({"background-color": getDataColor});
    });
    ...
    $('.slider-ipad').slick({
        dots: false,
        arrows: true,
        prevArrow:"<button type='button' class='slider-ipad__prev'></button>",
        nextArrow:"<button type='button' class='slider-ipad__next'></button>"
    });
    ...
    $('.item').matchHeight();
    $('.head-info__item').matchHeight();
    $('.price__item').matchHeight();

    $(window).resize(function () {
        if($(window).width() <= 768){
            $('.text-block-grey__item').removeClass('item');
        }
    });
    ...
    var sw = new ScrollWatch({
        watch: '[data-scroll-watch-ipad]',
        inViewClass: 'scroll-watch-in-view-ipad'
    })
